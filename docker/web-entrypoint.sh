...
temporal_langgraph_backend_url="$(js_escape "${TEMPORAL_LANGGRAPH_BACKEND_URL:-http://localhost:8002}")"
...
write_temporal_backend() {
  ...
  temporal: {
    ...
    conversationLinkBase: "${temporal_ui_url}/namespaces/default/workflows",
  }
EOF
}
