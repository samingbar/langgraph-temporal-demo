...
def system_prompt(customer_email: str) -> str:
    ...
    Account-scoped tools never accept an email generated by the model; the
    workflow supplies this authenticated value separately in every ToolRequest.
    """
...
# This provider-neutral JSON Schema is translated by each LLM adapter. Keeping
# one capability catalog prevents the three demo variants from drifting.
TOOLS = [
    {
        "name": "search_music",
        "description": (
